...
public class MainFrame {
	...
	public MainFrame() {
		...
		RightPanelToMainFrameController.setFrame(this);
		createMainPanels();
		setIcon();
	...
	private void setIcon() {
		...
		if (System.getProperty("os.name").startsWith("Windows")) {
			img = new ImageIcon(getClass().getResource("/main/res/bus.ico"));
		} else {
			img = new ImageIcon(getClass().getResource("/main/res/bus.png"));
		}
